...
import com.astracine.backend.presentation.dto.payment.MockPaymentConfirmResponse;
import com.astracine.backend.presentation.dto.payment.MockPaymentCreateResponse;
...
import com.astracine.backend.presentation.exception.PaymentSessionNotFoundException;
...
public class PaymentMockService {
    ...
    public MockPaymentCreateResponse createSession(String holdId, String userId) {
        ...
        PaymentSession session = new PaymentSession(paymentSessionId, holdId, userId, amount, "PENDING", expiresAt,
                qrPayload);
    ...
    private PaymentSession readSessionOrThrow(String paymentSessionId) {
        ...
        if (s == null)
            throw new PaymentSessionNotFoundException(paymentSessionId);
        return s;
    }
    ...
    private static class PaymentSession {
        ...
        private PaymentSession(String id, String holdId, String userId, long amount, String status, long expiresAt,
                String qrPayload) {
            this.id = id;
            this.holdId = holdId;
            this.userId = userId;
